...
export const AuthContextProvider = ({ children,authTokens }) => {
  const EndPoint = '/api/users'
    ...
    return (
        <AuthContext.Provider value={{ user, googleSignIn, logOut, authToken, usage, setusage, Token,usagErrorMessage, tokenLoading, setUser, setTokenLoading, aboutq,setaboutq, setSumarizationText, sumarizationText,chatData, setChatData,question, message, setMessage,setAuthToken, about, setAbout, lastAnswer, setLastAnswer, isDark, setIsDark }}>
            {children}
