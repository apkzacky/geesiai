...
const Contact = () => {
  const {user, isDark}:any = UserAuth()
  const EndPoint = '/'
...
const handleChange = (e) => {
    ...
    const sendFeedBack = () => {
      ...
      axios.post(`${EndPoint}api/auth/feedback`, {email, name, message})
                        .then((response) => {
  ...
  return (
    <section id="contact" className={`${isDark ? 'text-white':'text-black'} overflow-hidden py-16 md:py-20 lg:py-28`}>
              ...
              <div>
                <div className="-mx-4 flex flex-wrap">
                  ...
                  <div className="w-full px-4">
                    ...
                    className="mb-5 rounded-box flex w-full cursor-pointer items-center justify-center border border-white  px-12 py-4 text-base font-medium  shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark bg-primary/60">
 ...
 <footer className="footer footer-center p-10   mt-24">
