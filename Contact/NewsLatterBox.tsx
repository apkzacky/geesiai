...
const NewsLatterBox = (props) => {
    const EndPoint = '/'
    const {user, authToken, isDark}:any = UserAuth()
  ...
  const [laoding, setLoading] = useState(false)
      ...
      axios.post(`${EndPoint}api/auth/subscribe`, {email, authToken})
                        .then((response) => {
  ...
  return (
    <div className="relative z-10  rounded-box  p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        <input
          ...
          className={`mb-5 rounded-box flex w-full cursor-pointer items-center justify-center border  ${props.isDark ? 'bg-black border-white':'bg-white border-black'} px-9 py-4 text-base font-medium  shadow-submit duration-300 hover:bg-black/90 dark:shadow-submit-dark`}
        />
