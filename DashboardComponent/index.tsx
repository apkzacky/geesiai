...
const Community = (props) => {
  const {isDark}:any = UserAuth()
   ...
   <div className="items-start justify-center flex sm:pl-10 px-3" style={{flexDirection:'column'}}>
<h2 className="mb-3 text-2xl font-bold text-dark sm:text-3xl lg:text-2xl xl:text-3xl">
            Welcome! {props.displayName}.
              ...
              <p className="mb-10 text-base font-medium text-body-color">
                Discover a revolutionary way to learn with our Geesi AI.
              </p>
   </div>
        ...
        <div  className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
          {testimonialData.map((testimonial) => (
            <SingleTestimonial key={testimonial.id} testimonial={testimonial} isDark={isDark} />
          ))}
        </div>
      </div>
